...
parser.add_argument(
    ...
    type=str,
    required=False,
    help='path to AVD RGB directory (if omitted, will skip AVD loader)'
)
parser.add_argument(
    '--depth_dir',
    type=str,
    required=False,
    help='path to AVD depth directory (if omitted, will skip AVD loader)'
)
parser.add_argument('--grid',default=[8,8])
parser.add_argument('--dropout_rate',default=0.3)
parser.add_argument('--noise_mm',default=10)
